...
const TeamSection = () => {
  return (
    <div className="bg-[#011627] text-white min-h-screen py-16 px-8 md:px-24 font-sans selection:bg-[#4fb3e8]/30">
      ...
      {/* Header */}
      <header className="text-center max-w-3xl mx-auto mb-20 animate-slide-up">
      ...
      <main className="max-w-6xl mx-auto space-y-24">
        {/* CEO SECTION: AISHA */}
        <section className="flex flex-col md:flex-row items-start gap-10 animate-slide-up animation-delay-200">
          ...
          <div className="w-full md:w-8/12 pt-1">
            ...
            <div className="text-slate-300 space-y-4 leading-relaxed text-base">
              <p>
                ...
                from AI. As a Data & AI Strategist at Accenture Federal Services
                — where she led analytics transformation for public sector
                clients including enterprise reporting oversight for PEPFAR —
                and a management consultant at Booz Allen Hamilton, she spent
                her career applying technology and data to the hardest problems
                in government and global development.
              </p>
              <p>
                What she kept seeing was a gap: the infrastructure to connect
                capital, technology, and workforce development existed in pieces
                but never as a coherent investment thesis.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 pt-12 border-t border-white/5 animate-slide-up animation-delay-400">
          {/* LATONYA (Image Right) */}
            ...
            <div className="flex-1 order-2 sm:order-1">
              ...
              <div className="text-slate-300 text-sm space-y-3 leading-relaxed">
                <p>
                  ...
                  LaTonya Blakes is the person who goes in to build it. Seconded
                  from Arise Funds to SBTS Group LLC, she leads the HR
                  infrastructure, compliance frameworks, talent systems, and
          ...
          <section className="flex flex-col sm:flex-row gap-6">
            <div className="flex-1">
              ...
              <div className="text-slate-300 text-sm space-y-3 leading-relaxed">
                <p>
                  Laura C. Rudert has spent more than 20 years deploying over $4
                  billion across climate, infrastructure, and development
                ...
                <p>
                  ...
                  Director of Strategy & Management. An HKS MPP alumna — she has
                  operated on both sides of the capital table.
                </p>
              </div>
              <div className="flex gap-4 mt-4 text-slate-400">
                <FaFacebookF className="hover:text-white cursor-pointer" />
